...
Seymour offers open-source and easy-to-configure active monitoring allowing allows users to simulate requests from globally distributed locations to test their API endpoints. For each test, Seymour measures the availability, response time, and correctness of an API endpoint response. 
